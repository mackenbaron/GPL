...
bool ParsingArgs::AddArgType(const char shortName, const char * longName /*= NULL*/, KeyFlag flag/*=NO_VALUE*/)
{
...
int ParsingArgs::Parse(const std::string & ps, std::map<std::string, std::vector<std::string> > & result, std::string &errPos)
{
